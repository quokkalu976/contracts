...
library LibTradingCore {
    ...
    bytes32 constant TRADING_CORE_POSITION = keccak256("trading.core.storage");
    ...
    function fundingFeeRate(
        ...
        int256 fundingFeeR;
        // abs(longPosition - shortPosition) / max(longPosition, shortPosition)
        // cap(min, fundingFeeR, max)
